...
Pour des raisons de sécurité et de confidentialité, la clé API Groq n’est pas incluse dans le code.
GitHub bloque automatiquement les push contenant des clés API.
